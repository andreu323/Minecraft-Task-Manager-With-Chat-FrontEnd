...
<div
    ...
    class="text-[16px]   min-w-[200px] break-words relative flex flex-row items-center gap-2 flex-wrap bg_px_round text-green-500 p-3"
>
    ...
    <div class="flex flex-row items-center gap-3 shrink-0">
        <p class="text-[16px] shrink-0 relative">разблокировал:</p>
        <img
            alt=""
            width="30"
            height="30"
